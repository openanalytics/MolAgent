...
def main(**kwargs):
    ...
    # Save refitted model
    # Disable reproducibility check if blender properties or 3D features were used
    # (reproducibility SMILES are hardcoded generic molecules with no 3D representation)
    has_3d_features = any(fk in model.feature_generators for fk in ['prolif', 'AffGraph'])
