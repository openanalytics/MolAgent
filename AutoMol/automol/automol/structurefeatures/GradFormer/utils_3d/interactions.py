...
from automol.structurefeatures.GradFormer.utils_3d.base import (
    BasePiStacking,
    Distance,
    DoubleAngle,
    Interaction,
    SingleAngle,
   angle_between_limits, get_centroid, get_ring_normal_vector,
)
#from utils_3d.base import angle_between_limits, get_centroid, get_ring_normal_vector
...
class PiStacking_FaceToFace(BasePiStacking):
...
class PiStacking_EdgeToFace(BasePiStacking):
...
class PiStacking(Interaction):
    ...
    def __init__(self, ftf_kwargs=None, etf_kwargs=None):
        self.ftf = PiStacking_FaceToFace(**ftf_kwargs or {})
        self.etf = PiStacking_EdgeToFace(**etf_kwargs or {})
